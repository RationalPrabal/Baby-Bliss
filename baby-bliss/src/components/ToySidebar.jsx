...
import MobileFilterToys from './MobileFilterToys'
const ToySidebar = ({OrderPrice,OrderDiscount,FilterPrice,FilterCategory}) => {
...
All
    ...
    {
      show ? <MobileFilterToys OrderPrice={OrderPrice} OrderDiscount={OrderDiscount} FilterPrice={FilterPrice}FilterCategory= {FilterCategory}/> : ""
    }
    </Box>
  </>
  )
